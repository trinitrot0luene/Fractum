...
namespace Fractum.Rest.Utils
{
    public class RouteBuilder
    {
        ...
        private List<(RouteSection, object)> RouteObjects { get; set; }
        ...
        public string GetBucketRoute()
        {
            ...
            return string.Concat(majorParam?.Item1.BaseRoute, string.Join("", RouteObjects.Skip(1).Select(r => string.Format(r.Item1.BaseRoute, r.Item2))));
        }
        ...
        public Uri Build()
        {
            var urlString = string.Concat(Consts.API_BASE_URL, string.Join("", RouteObjects.Select(r => string.Format(r.Item1.BaseRoute, r.Item2))));
